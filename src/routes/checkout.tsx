          ...
          <div className="lg:col-span-2">
            ...
            {step < 4 && (
              <div className="mt-6 flex flex-wrap justify-between gap-3">
                ...
                <button onClick={next} className="inline-flex items-center gap-1 rounded-full gradient-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-soft hover:shadow-glow">
                  {step === 3 ? "Place Order" : "Next"} <ChevronRight className="h-4 w-4" />
                </button>
              </div>
            )}
          </div>
